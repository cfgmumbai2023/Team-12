...
import { ChannelDetail, VideoDetail, SearchFeed, Feed } from './components/Videos'
        ...
        <Router>
          {
            userData.loading ? (
              ...
              <Switch>
                ...
                <Route exact path='/videos' component={Feed} />
                <Route path='/video/:id' component={VideoDetail} />
                <Route path='/videos/channel/:id' component={ChannelDetail} />
                <Route path='/videos/search/:searchTerm' component={SearchFeed} />
                <Redirect to ="/" />
              </Switch> 
            ) : (
              <Switch>
