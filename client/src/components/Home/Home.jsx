          ...
          <div className="row">
            <div className="col-lg-6 pt-5 pt-lg-0 mb-5 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <div>
                ...
                <p>JEET Stands for "Joint Efforts for Educational Transformation". <br/>It is an all-India alliance of NGOs engaged in Education (Sports and Vocational included) ready to work with Governments, Organizations, Institutions, and Individuals to eradicate inequality and promote quality in the Indian education system. We provide links to free videos to the disadvantaged groups up to standard XII. Join this movement, NOW!<br/> and digital collaboration to classrooms.</p>
                  {
                    (userData.token) ? 
        ...
        <div className="row p-0 m-0">
            <div className="col-12 col-md-6 d-flex justify-content-center justify-content-md-start px-0 py-2">
                <div className="Footer_Copyright pe-2 pe-md-4 ms-0 ms-md-5 fw-bold">
                  <CopyrightIcon style={{fontSize: "16px", marginTop: "-5px"}}/> JEET 2023
                </div>
